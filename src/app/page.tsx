...
export default function Home() {
  ...
  return (
    <ContextProvider>
      <main className="flex flex-col min-h-screen items-center justify-start text-center bg-gradient-to-r from-accent to-secondary">
      <div className = "justify-start h-24 w-full">
        ...
        <div className="flex flex-col justify-left text-left p-24">
          ...
          <Link href="/chat" legacyBehavior>
            <a className="bg-primary hover:bg-secondary text-white text-xl font-bold py-3 px-4 rounded-full w-32 transition-colors">
              Let&apos;s chat
            </a>
          </Link>
        </div>
